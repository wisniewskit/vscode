...
// navigator.clipboard.readText() is required for pasting. When loading over http,
// navigator.clipboard can be undefined. See https://github.com/microsoft/monaco-editor/issues/2313
const supportsPaste = 'clipboard' in navigator && 'readText' in navigator.clipboard;
